...
/**
 * Servlet implementation class EEEView
 */
public class EEEView extends HttpServlet {
   ...
   String headName;
	...
	public void init(ServletConfig config) throws ServletException {
		headName =config.getInitParameter("Eeehead");
