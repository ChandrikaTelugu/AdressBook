...
/**
 * Servlet implementation class CSEView
 */
public class CSEView extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		headName = config.getInitParameter("Csehead");
